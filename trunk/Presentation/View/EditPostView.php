...
class Presentation_View_EditPostView extends Presentation_View_View
{
    ...
    public function Display()
    {
        ...
        $form = '<fieldset><legend><img src="UI/Themes/Images/Controls/editpost.png" id="controlbarimg" /> Edit Post</legend>'
            ...
            . '<input type="text" name="title" maxlength="30" size="30" value="'.$this->post->GetTitle().'"></td></tr>'
            ...
            . '<tr><td colspan="2"><textarea name="content" rows="15" cols="60">'.$this->post->GetACLPSContent().'</textarea></td></tr>'
